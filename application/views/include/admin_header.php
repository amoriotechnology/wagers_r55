...
<?php endif; ?>
         ...
         <li class="treeview ">
            ...
            <ul class="treeview-menu">
               <li class="treeview"> <a href="<?php echo base_url('Chrm/payroll_setting?id=' . $encode_com_id . '&admin_id=' . $encode_admin_id);?>">Payroll Setting</a> </li>
               <li class="treeview  "><a href="<?php echo base_url('Chrm/payslip_setting?id=') . $encode_com_id . '&admin_id=' . $encode_admin_id;?>">Payslip Setting</a></li>
               <li class="treeview  "><a href="<?php echo base_url('Company_setup/manage_company?id=') . $encode_com_id . '&admin_id=' . $encode_admin_id;?>">Manage My Company</a></li>
               <li class="treeview  "><a href="<?php echo base_url('Chrm/week_setting?id=') . $encode_com_id . '&admin_id=' . $encode_admin_id;?>">Week Setting</a></li>
               ...
               <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                     <li class="treeview"><a href="<?php echo base_url('Cweb_setting/notifications?id=') . $encode_com_id . '&admin_id=' . $encode_admin_id;?>">Notification</a>
                     </li>
                     <li class="treeview                                          <?php echo($this->uri->segment(2) == 'calender_view') ? 'active' : ''; ?>">
                        <a href="<?php echo base_url('Cweb_setting/calender_view?id=') . $encode_com_id . '&admin_id=' . $encode_admin_id;?>">
