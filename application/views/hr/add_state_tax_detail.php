...
<div class="content-wrapper">
   ...
   <section class="content">
     <?php
      ...
      <?php  
      if (strpos($weekly_taxinfo[0]['tax'], 'Income tax') == false) { ?>
      <div class="row">
...
<?php if (strpos($weekly_taxinfo[0]['tax'], 'Income tax') !== false) { ?>
<div class="row">
...
<?php }  ?>
<br>
<?php if (strpos($biweekly_taxinfo[0]['tax'], 'Income tax') !== false) { ?>
...
<?php  if (strpos($monthly_taxinfo[0]['tax'], 'Income tax') !== false) { ?>
<div class="row">
   <div class="col-sm-12">
      <div class="panel panel-default" style="border:3px solid #d7d4d6;margin-left:15px;width:1602px;" >
         <div class="panel-body btnclr">
