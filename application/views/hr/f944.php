...
?> 
                ...
                <div class="row1">
                    <input type="text" value="$<?php echo $inter; ?>"  style="margin-left: -37px;width: 80px;text-align: right;"  /> 
...
?>
                ...
                <div class="row2">
                    <input type="text" value="$<?php echo $inter1; ?>"  style="margin-left: -57px;text-align: right;width: 80px;"  />
                    <input type="text" value="<?php echo $decimal1; ?>"  style="width: 17px;margin-left: 4px;" />
...
?>
                ...
                <div class="row4">
                    ...
                    <input type="text" value="<?php echo $decimal2; ?>" style="margin-left: 3px;"/>
...
?>
                ...
                <div class="row4c">
                    <input type="text" value="$<?php echo $inter6; ?>"  style="margin-left: -50px; text-align: right;"  />
                    <input type="text" value="<?php echo $decimal6 ; ?>" style="margin-left: 5px;"/>
...
?>
                ...
                <div class="row4c2a">
                    <input type="text" value="$<?php echo $inter7; ?>" style="margin-left: -54px;text-align: right;" />
                    <input type="text" value="<?php echo $decimal7; ?>" style="margin-left: 5px;"/>
...
?>
                ...
                <div class="row5">
                    <input type="text" value="<?php echo $inter10; ?>" style="width: 80px;margin-left: -63px;text-align: right;" />
                     <input type="text" value="<?php echo $decimal10; ?>"  style="width: 17px;margin-left: 4px;" />
...
$decimal9 = isset($parts[1]) ? sprintf('%02d', $parts[1]) : '00'; 
...
?>
                 ...
                 <div class="row5a">
                    ...
                    <input type="text" value="<?php echo $decimal9; ?>"  style="width: 17px;margin-left: 4px;" />
            ...
            <div class="page-2" id="two">
                ...
                <div class="row8f">
                    <input type="text"  style="top: 4px;margin-left: -18px;position: absolute"  value="<?php echo $Federal_Pin_Number; ?>" />
                </div>
                <div class="row8g">
                  <input type="text" value="<?php echo 0; ?>" style="width: 80px;margin-left: -50px;text-align: right;" />
                     <input type="text" value="<?php echo "00"; ?>"  style="width: 20px;margin-left: 4px;" />
                </div>
                <div class="row9">
                   <input type="text" value="<?php echo $inter10; ?>" style="width: 80px;margin-left: -50px;text-align: right;" />
                     <input type="text" value="<?php echo $decimal10; ?>"  style="width: 17px;margin-left: 4px;" />
                </div>
                <div class="row10a">
                    <input type="text" value="<?php echo $inter10; ?>" style="width: 80px;margin-left: -50px;text-align: right;" />
            ...
            <div class="page-3" id="three">
                ...
                <div class="ein-p3">
                    <input type="text" value="<?php echo $Federal_Pin_Number; ?>" style="top: 1px;margin-left: -17px;position: absolute">
                </div>
                <div class="row14">
                    <input type="checkbox">
                </div>
            ...
            <div class="page-5" id="five">
                ...
                <div class="row1-ein">
                    <input type="text" value="<?php echo $Federal_Pin_Number; ?>" style="position: absolute;left: 6px;top: -10px;" />
                </div>
                <div class="dollar">
